...
const Index: React.FC = () => {
  ...
  return (
    <div className={'bg-white dark:bg-[#18181B] '}>
      <Title> Newsletter Lenderson Macedo</Title>
      ...
      <ThemeToggle />
			...
			<div className={'text-center mt-8 select-none'}>
				<h2 className={'text-3xl font-bold dark:text-white'}>
					Novidades e curiosidades para quem  <span className={'font-bold dark:text-[#59FFF5] text-[#59AFFF]'}>não quer perder tempo procurando!</span>
				</h2>
